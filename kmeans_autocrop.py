...
def get_capture_one_coordinates(rect, angle, autocrop_height, camera_width = 8256, camera_height = 6192):
...
class NegativeScan:
    ...
    def blur_image(self):
        ...
        if len(self.image_cv2.shape) > 2:  # NOT grayscale
            image_cv2 = cv2.cvtColor(self.image_cv2, cv2.COLOR_BGR2GRAY)
